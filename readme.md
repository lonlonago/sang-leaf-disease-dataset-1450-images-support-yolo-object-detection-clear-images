# Sang leaf disease dataset 1450 images support YOLO object detection clear images

# Body

Sang Leaf Disease Dataset, 1450 images, supports YOLO object detection, the images are clear, and the bounding boxes are complete, suitable for training models for disease detection.
The dataset format is standardized, directly usable, and saves time and effort.
Note
